...
We started with the positions in the Google sheet. Next, we looked at the unclean columns and determined how we wanted to find consistency of syntax and structure. We choose to capitalize all letters, separating positions with a slash if there we multiple positions. Next, we wrote our google sheet with the cleaned positions into a CSV, before joining it with the other roster data set. This provided us cleaned data with accurate positions assignments and syntax. 
